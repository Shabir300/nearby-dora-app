...
export const Icons = {
  ...
  List: () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      <path fillRule="evenodd" d="M2.625 6.75a1.125 1.125 0 112.25 0 1.125 1.125 0 01-2.25 0zM7.125 12a1.125 1.125 0 112.25 0 1.125 1.125 0 01-2.25 0zM3.75 17.25a1.125 1.125 0 100 2.25 1.125 1.125 0 000-2.25zM12 18.375a.375.375 0 01.375-.375h8.25a.375.375 0 010 .75h-8.25a.375.375 0 01-.375-.375zM12.375 12a.375.375 0 000 .75h8.25a.375.375 0 000-.75h-8.25zm0-6.375a.375.375 0 000 .75h8.25a.375.375 0 000-.75h-8.25z" clipRule="evenodd" />
    </svg>
  ),
  Share: () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      <path fillRule="evenodd" d="M15.75 4.5a3 3 0 11.825 2.066l-8.421 4.679a3.002 3.002 0 010 1.51l8.421 4.679a3 3 0 11-.729 1.31l-8.421-4.678a3 3 0 110-4.132l8.421-4.679a3 3 0 01-.1-.735z" clipRule="evenodd" />
    </svg>
  ),
  Play: () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
